...
function displayTemperatureResults(data) {
    ...
    html += '<div class="temp-header">';
    html += '<div class="temp-value">🔥 Температура: 1.2</div>';
    html += '<div class="temp-label">Креативный</div>';
    html += '</div>';
    html += '<div class="temp-description">';
    html += `<p>${escapeHtml(data.temperatures['1.2'].description)}</p>`;
    html += '</div>';
    html += '<div class="temp-response">';
    html += `<pre>${escapeHtml(data.temperatures['1.2'].response)}</pre>`;
    html += '</div>';
    html += '</div>';
    ...
    html += '<h4>🔥 Температура 1.2</h4>';
    html += `<p>${escapeHtml(data.recommendations['1.2'])}</p>`;
    html += '</div>';
    ...
    html += '<li><strong>Креативность:</strong> При температуре 1.2 модель проявляет максимальную креативность и разнообразие, отлично для творческих задач.</li>';
    ...
    html += '<li><strong>Разнообразие:</strong> Чем выше температура, тем больше вариативность ответов при повторных запросах.</li>';
    html += '</ul>';
    html += '</div>';
